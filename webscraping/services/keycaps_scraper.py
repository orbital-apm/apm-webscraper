...
KEYCAP_LISTINGS_URL = "https://keeb-finder.com/keycaps"
...
with sync_playwright() as p:
    ...
    for pagination in range(1, pages, 1):
        listings_page.goto(f"https://keeb-finder.com/keycaps?page={pagination}")
        listings_page.screenshot(path="example_keycaps.png", full_page=True)
        for article in range(1, articles + 1, 1):
            ...
            try:
                material = details.query_selector('body > div.flex.flex-col.gap-4 > section:nth-child(1) > div > div.col-span-12.md\:col-span-5.md\:order-2.order-3 > \
                                                  div:nth-child(1) > div:nth-child(2) > div:nth-child(3) > div.flex > div').inner_text()  # type: ignore
                if material == "Unknown":
                    material = None
                else:
                    pass
            ...
            try:
                profile = details.query_selector('body > div.flex.flex-col.gap-4 > section:nth-child(1) > div > div.col-span-12.md\:col-span-5.md\:order-2.order-3 > \
            ...
            vendors_data = details.query_selector_all('body > div.flex.flex-col.gap-4 > section:nth-child(1) > div > div.col-span-12.order-2.md\:order-3.mt-2 > \
                                                      div.bg-gray-50.dark\:bg-gray-700.mt-4.rounded-lg.shadow-md.border.border-gray-200.dark\:border-gray-800 > table > \
                                                      tbody > tr:nth-child(2) > td.flex.items-center.p-2 > div > img')
